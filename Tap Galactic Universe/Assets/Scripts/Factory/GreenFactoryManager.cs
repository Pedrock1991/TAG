...
public class GreenFactoryManager : MonoBehaviour {
	...
	public void SaveGame () {
		...
		PlayerPrefs.SetString ("GreenFactoryManagerSave", Helper.Serialize<SaveFactory> (save));
	}

	public void LoadGame () {
		if (PlayerPrefs.HasKey ("GreenFactoryManagerSave")) {
			save = Helper.DeSerialize<SaveFactory>(PlayerPrefs.GetString("GreenFactoryManagerSave"));
