...
namespace CompleteProject
{
	...
	public class ShopManager : MonoBehaviour, IStoreListener
	{
		...
		public static string kProductIDShop1 = "shop10goldcoin";   
		public static string kProductIDShop2 = "shop25goldcoin";
		public static string kProductIDShop3 = "shop50goldcoin";
		public static string kProductIDShop4 = "shop100goldcoin"; 
		public static string kProductIDShop5 = "shop250goldcoin"; 
		...
		public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
		{
			...
			if (String.Equals(args.purchasedProduct.definition.id, kProductIDShop1, StringComparison.Ordinal))
			{
				...
				// The consumable item has been successfully purchased, add 10 gold coin to the player's in-game score.
			...
			{
				Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
				// The consumable item has been successfully purchased, add 25 gold coin to the player's in-game score.
				GameManager.instance.SetGoldCoins (25);
			}
			...
			{
				Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
				// The consumable item has been successfully purchased, add 50 gold coin to the player's in-game score.
				GameManager.instance.SetGoldCoins (50);
			}
			...
			{
				Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
				// The consumable item has been successfully purchased, add 100 gold coin to the player's in-game score.
				GameManager.instance.SetGoldCoins (100);
			}
			...
			{
				Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
				// The consumable item has been successfully purchased, add 250 gold coin to the player's in-game score.
				GameManager.instance.SetGoldCoins (250);
			}
